...
const feedbacks = [
  ...
  },
  {
    ...
    store: "App Store",
    rate: 5,
    comment: "Really happy with Shpock helped me grow my business",
  },
  {
    name: "Lenny Green",
    store: "Google Play",
    rate: 5,
    comment: "Intuitive interface, so easy to use",
  },
  {
    name: "Andrew Ahad",
    store: "Google Play",
    rate: 5,
    comment:
      "Also a lot of great items for sale. App works very well. Shpock has started a delivery service which is doing well.",
  },
  {
    name: "Sophie Palmer",
    store: "App Store",
    rate: 5,
    comment: "Amazing because everything gets sold so fast.",
  },
  {
    name: "Sophie Palmer",
    store: "App Store",
